    ...
    <div className="space-y-12 pb-24">
      ...
      {invitations && invitations.length > 0 && (
        <div className="space-y-4">
          <h3 className="text-sm font-black text-gray-400 uppercase tracking-[0.2em] px-4">Bekleyen Davetler</h3>
          <div className="grid gap-4">
            {invitations.map(inv => (
              <div key={inv.id} className="bg-white dark:bg-gray-800 p-6 rounded-[2.5rem] border border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-lg">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-black text-orange-600 uppercase tracking-widest">₺{inv.base_daily_wage} Yevmiye</p>
                  </div>
                </div>
